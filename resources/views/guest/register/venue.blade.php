...
<body class="form-v10">
    ...
    <div class="page-content pt-5">
        <div class="form-v10-content">
            <form class="form-detail" action="{{ url('register/venue/submit') }}" method="post" id="venueregister">
                @csrf
                
                <div class="form-left">
                    <h2>General Infomation</h2>
                    <div class="form-row">
                        <input type="text" name="namavenue" class="namavenue" id="namavenue" placeholder="Nama Venue">
                    </div>
                    <div class="form-row">
                        <input type="text" name="alamatvenue" class="alamatvenue" id="alamatvenue" placeholder="Alamat Venue">
                    </div>
                    <div class="form-row">
                        <input type="text" name="zipvenue" class="zipvenue" id="zipvenue" placeholder="Zip">
                    </div>
                    <div class="form-row">
                ...
                <div class="form-right">
                    ...
                    <div class="form-row">
                        <input type="text" name="namapemilik" class="namapemilik" id="namapemilik" placeholder="Nama Pemilik">
                    </div>
                    <div class="form-row">
                        <input type="text" name="nik" class="nik" id="nik" placeholder="NIK">
                    </div>
                    <div class="form-row">
                        <input type="text" name="telp" class="telp" id="telp" placeholder="Telepon">
                    </div>
